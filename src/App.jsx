...
import { InputBoxD } from './components/Index.js'
...
function App() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url(https://images.pexels.com/photos/259249/pexels-photo-259249.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)",
      }}
    >
        ...
        <div className='w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 background-blur-sm bg-white/30'>
          <form onSubmit={(e) =>{ e.preventDefault(); convert() } }>
            <div className='w-full mb-1'>
              <InputBoxD label="from" amount={amount} currencyOptions={options} 
            ...
            <div className='w-full mb-1'>
              <InputBoxD label="to" currencyOptions={options} amount={convertedAmount}
